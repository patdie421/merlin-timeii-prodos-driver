...
* The LIBSRC directory contains the configured libraries. Each file (.O.S extension) includes one of the files from the LIB directory. Only that .O.S file needs to be created/modified and compiled.  
