...
# Why Merlin?
I could use a modern tool chain but I'd to understand how programming was done in the 80s/90s, I decided to do everything by using a real Apple IIe (and now also an Apple IIc+), and this is all the more necessary since no emulator simulates this card!  
